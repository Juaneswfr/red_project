...
<html lang="en">
    ...
    <body id="products_body">
        ...
        <section id="collection_1">
            <h4> Sorprendete con nuestra <span> colección de verano</span></h4>
        ...
        <section id="elegant_promo">
                ...
                <section>
                    <div class="sized_products">
                        ...
                        <div class="figure_b">
                            ...
                            <a href="#elegant_promo"> 30% DCTO AQUI</a>   
                            <p class="jap"> 審美的な服 </p>                         
                        </div>
                    </div>
                </section>
            ...
            <section id="collection_1">
                <p class="tittle"> Descuentos Del <span>30%</span></p>
                <p class="jap">
                    エレガントな割引
                </p>
                <section id="products">
