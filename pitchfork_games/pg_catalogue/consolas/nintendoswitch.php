            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        <figure class="image">
                            <img src="/pg_images/nintendoswitch32gb_product.png"> 
                        </figure>
                        <div class="content">
                            <h1>Consola Nintendo swicth</h1>
                            <h2>Consola nintendo switch-32gb, negra, joy-con rojo-azul</h2>
                            <h3><br>CARACTERISTICAS</br<</h3>
                            <p> 
                                <br>- La consola Nintendo Switch está diseñada para cualquier estilo de vida, <br> transformándose rápidamente de una consola casera a una consola portátil.</br>
                                
                                <br>- disfruta de sus distintos modos de uso modo TV, modo semi-portatil, modo portatil</br>
                                
                                <br>
                                - Juntos es mejor: Opciones de juego multijugador: <br> - Modo local <br> - Modo local cooperativo <br> - Juego en línea
                                </br>
                                </p>
...
<footer>
    <section class="footer" id="wrap_footer">
        <!--div class="pg_content">
            ...
            <div>
                 <textarea id="mensaje" name="mensaje" placeholder="introduzca gb_productsu mensaje..."></textarea>
                 <hr>
            </div>
            <div>
