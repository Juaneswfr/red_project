            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        <figure class="image">
                            <img src="/pg_images/xboxone1tb_product.jpg"> 
                        </figure>
                        <div class="content">
                            <h1>Consola Xbox one</h1>
                            <h2>Consola microsoft xbox one 1 Tera blanca</h2>
                            <h3><br>CARACTERISTICAS</br<</h3>
                            <p> 
                                <br>- Juega online con amigos, obtén juegos gratis, guarda los juegos online</br>
                                
                                <br>- con la suscripción incluida de 14 días de xbox game pass ultimate</br>
                                
                                <br>- Disfruta de las caracteristicas y juegos exclusivos de la familia xbox one y remasterizados de generaciones anteriores</br>

                                <br>- ¡LOS JUEGOS SE VENDEN POR SEPARADO!</br>         
