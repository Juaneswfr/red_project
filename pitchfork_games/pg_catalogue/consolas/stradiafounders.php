...
<head>
    ...
    <title>Google stadia founder's</title>
            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        <figure class="image">
                            <img src="/pg_images/googlestadiafounders_product.png"> 
                        </figure>
                        <div class="content">
                            <h1>Consola Google stadia</h1>
                            <h2>Consola google stadia founder's edición</h2>
                            <h3><br>CARACTERISTICAS</br<</h3>
                            <p> 
                                <br>- Juega online donde quieras, cuando quieras al instante</br>
                                
                                <br>- Con google chromecast ultra juega en tú tv, en tú pc, en tú telefono movil</br>
                                
                                <br>- Levanta y juega</br>
                                </p>
