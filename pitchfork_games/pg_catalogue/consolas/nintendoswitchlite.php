            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        <figure class="image">
                            <img src="/pg_images/switchlite32gb_product.png"> 
                        </figure>
                        <div class="content">
                            <h1>Consola Nintendo swicth lite</h1>
                            <h2>Consola nintendo switch-32gb, amarilla</h2>
                            <h3><br>CARACTERISTICAS</br<</h3>
                            <p> 
                                <br>- La consola Nintendo Switch lite está diseñada para el juego portátil</br>
                                
                                <br>- Compacta y ligera, controles integrados, compatible con los juegos de su hermana mayor nintendo switch</br>
                                
                                <br>
                                - Juntos es mejor: Opciones de juego multijugador: <br> - Modo local <br> - Juego en línea
                                </br>
                                </p>
