...
<head>
    ...
    <title>horizon Zero Dawn Complete Edition PS4</title>
            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        ...
                        <div class="content">
                            <h1>horizon zero dawn complete edition (PS4)</h1>
                            <h2>sony interactive entertaiment - acción/rol</h2>
                            <h3><br>teen - adolecentes</br<</h3>
                            <p> 
                                <br>Conviértete en la habilidosa cazadora Aloy y explora un mundo exuberante habitado por misteriosas criaturas mecanizadas, en un nuevo y emocionante juego de rol, acción y mundo abierto, exclusivamente para la consola PlayStation®4.
