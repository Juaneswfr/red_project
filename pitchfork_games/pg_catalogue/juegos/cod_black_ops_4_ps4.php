...
<head>
    ...
    <title>COD Black ops 4 PS4</title>
            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        ...
                        <div class="content">
                            <h1>Call of Duty : Black Ops 4 (PS4)</h1>
                            <h2>activision - shooter</h2>
                            <h3><br>mature 17+</br<</h3>
                            <p> 
                                <br>Regresa Black Ops! Y lo hace con un combate multijugador fluido, asentado y descarnado; con el mayor modo Zombis hasta la fecha y tres aventuras llenas de no muertos; y con Blackout, donde el universo Black Ops cobra vida en una enorme experiencia de guerra total.
