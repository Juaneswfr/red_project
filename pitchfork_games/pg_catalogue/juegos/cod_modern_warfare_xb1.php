...
<head>
    ...
    <title>COD Modern warfare Xbox One</title>
            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        ...
                        <div class="content">
                            <h1>Call of Duty : modern warfare (xbox one)</h1>
                            <h2>activision - shooter</h2>
                            <h3><br>mature 17+</br<</h3>
                            <p> 
                                <br>Vive una Campaña dramática o reúne a tu equipo en el juego en línea definitivo con una combinación de modos y mapas Multijugador, el estreno del sistema de Pase de Batalla de la franquicia y Warzone, incluido para todos los jugadores en línea.
