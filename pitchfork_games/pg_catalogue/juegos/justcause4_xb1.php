...
<head>
    ...
    <title>Just cause 4 - Xbox One</title>
            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        ...
                        <div class="content">
                            <h1>just Cause (xbox one)</h1>
                            <h2>square enix - acción y aventura</h2>
                            <h3><br>mature 17+</br<</h3>
                            <p> 
                                <br>Bienvenido a Solís, un enorme mundo ubicado en Sudamérica sumido en el conflicto, la opresión y unas condiciones climatológicas extremas. En Just Cause 4, el agente rebelde Rico Rodríguez llega a Solís para descubrir la verdad sobre su pasado, sin importar el precio. ¡Abróchate tu traje aéreo, equipa el gancho personalizable y prepárate para desatar la tempestad!
                                </p>
