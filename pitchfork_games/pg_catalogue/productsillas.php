    ...
    <div class="list_product">
        <figure class="image_product"> <estas imagaenes deben ser 800x800>
            ...
            <div class="button_product">
                <a href="sillas/dxracer_formulaseries.php">VER DETALLES</a>
            </div>
            </figcaption>
            </a>
        </figure>
        <figure class="image_product">
            <a href="sillas/dxracer_racingseriespro.php">
            <img src="/pg_images/Racing Series PRO Vinyl and PU Leather RV131.jpg" alt="Racing series pro">
            <figcaption>
            <p>
                <b>DXRacer Racing<br>Series PRO</b>
            </p>
            <div class="price_product">
                <h2>$1.500.000</h2>
                <p>$0</p>
            ...
            <div class="button_product">
                <a href="sillas/dxracer_racingseriespro.php">VER DETALLES</a>
            </div>
            </figcaption>
            </a>
        </figure>
