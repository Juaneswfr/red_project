...
<head>
    ...
    <title>DXRacer Formula Series convencional</title>
            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        <figure class="image">
                            <img src="/pg_images/Formula Series Conventional Mesh and PU Leather FD101.jpg"> 
                        </figure>
                        <div class="content">
                            <h1>Dxracer formula series</h1>
                            <h2>convencional - color : black</h2>
                            <h3><br></br<</h3>
                            <p> 
                                <br>disfruta de la comodidad de esta fabulosa silla en cuero y microfibra adapatable y resistente para el use que necesites darle; perfecta para tu oficina o salon de juegos.
