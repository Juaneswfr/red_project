...
<head>
    ...
    <title>DXRacer Racing Series Pro</title>
            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        <figure class="image">
                            <img src="/pg_images/Racing Series PRO Vinyl and PU Leather RV131.jpg"> 
                        </figure>
                        <div class="content">
                            <h1>Dxracer racing series</h1>
                            <h2>PRO - color : black & white</h2>
                            <h3><br></br<</h3>
                            <p> 
