...
<head>
    ...
    <title>Intercambia tus juegos</title>
...
<body>
 ...
 <main>
    <section id="wrap_info_exchange" class="wrapper_style">
        <div class="curso_content">
            <div class="product">
                <article class="feature_left">
                    <div class="content">
                        <h1>condiciones para intercambiar tus juegos</h1>
                        <h3><br></br<</h3>
                        <p> 
                            <br>el intercambio de juegos puede ser realizado unicamente por juegos de xbox one y ps4, cumpliendo condiciones de estado fisico y funcional del videojuego presente a cambiar, dicho videojuego sera evaluado por un encargado en el area y tomara la decisión de por cual juego puede ser intercambiado, por cuanta cantidad de dinero o si debe encimar el excedente (depende el juego seleccionado).
                        </p>
                    </div>
                </article>
            </div>
