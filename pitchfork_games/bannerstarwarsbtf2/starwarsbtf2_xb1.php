...
<head>
    ...
    <title>Star wars battlefront II Xbox One</title>
            ...
            <div class="curso_content">
                <div class="product">
                    <article class="feature_left">
                        <figure class="image">
                            <img src="/pg_images/starwars-btf-2-xb1.png"> 
                        </figure>
                        <div class="content">
                            <h1>Star Wars Battlefront II (Xbox One)</h1>
                            <h2>electronic arts - shooter</h2>
                            <h3><br>teen - adolecentes</br<</h3>
                            <p> 
                                <br>Conviértete en héroe y métete en la piel de un soldado, pilotea un Caza estelar legendario, lucha como tu personaje favorito de STAR WARS o forja un camino como soldado de élite de las fuerzas especiales en una nueva aventura de STAR WARS.
