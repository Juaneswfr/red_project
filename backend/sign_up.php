...
<head>
    ...
    <script type="text/javascript" src="/backend/red_complement/validate_sign_up.js">
...
<body>
    ...
    <?php 
        include_once $_SERVER['DOCUMENT_ROOT'].'/backend/red_component/red_user/red_adm_user.php';
    ?>
</body>
