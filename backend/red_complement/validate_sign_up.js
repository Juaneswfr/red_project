$(document).ready(function() {
    ...
    ({
        ...
        messages:
        {
            name: {required: "Por favor ingrese su nombre", minlength: "Este campo debe tener mínimo 2 caracteres", maxlength: "Este campo debe tener menos de 60 caracteres"},
            user: {required: "Por favor ingrese su usuario", minlength: "Este campo debe tener mínimo 5 caracteres", maxlength: "Este campo debe tener menos de 20 caracteres"},
